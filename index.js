...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting ben-xmd to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing BEN XMD Plugins')
  const path = require('path');
