            ...
            try {
              ...
              if (_0x13e7a7) {
                await _0x2193c1.sendMessage(_0x51f5e6, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "MR OBED | " + _0x5ad7ef.title + ".mp4",
                  'caption': _0x5ad7ef.title + " | *© ⎝⧹ 𝙆𝙀𝙀𝙉𝙇𝙔 𝙓𝙈𝘿 ⧸⎠*"
                }, {
                  'quoted': _0x50c272
                });
              } else {
